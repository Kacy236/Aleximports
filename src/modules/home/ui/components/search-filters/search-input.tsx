...
interface Props {
  ...
  tenants?: any[]; // Passed from parent to avoid duplicate fetching
}
...
export const SearchInput = ({
  ...
  return (
    <div className="flex flex-col gap-3 w-full">
      ...
      {/* Row 2: Store Selector + Library + Filter (Side-by-side on mobile) */}
        ...
        {session.data?.user && (
          ...
          >
            <Link prefetch href="/library">
              <BookmarkCheckIcon className="size-4 sm:mr-2" />
